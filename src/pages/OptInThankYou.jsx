...
const OptInThankYou = () => {
  useEffect(() => {
    ...
    document.title = 'You’re In · The Trader’s Journey';
      ...
      <main className="flex-1 flex items-center justify-center px-5 md:px-8 py-20">
        <FadeUp>
          <div className="max-w-[520px] mx-auto text-center">
            ...
            <h1 className="text-[clamp(30px,6vw,48px)] font-tj-display font-black uppercase tracking-[0.02em] leading-[1.1]">You&rsquo;re In</h1>
