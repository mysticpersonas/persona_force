...
const PftThirtyDay = () => (
  <ProductPage
    docTitle="30-Day Mapping · PersonaForce Trader™"
    bookSource="pft-30day"
    ...
    forYou={[
      'You completed the 5-Day Challenge and want to go deeper',
      'You have a strategy but your identity keeps overriding it',
      'You are ready to work with your Blueprint Map with support',
      'You want accountability and structure around identity work',
      'You are committed to 30 days of focused pattern work',
    ]}
    notForYou={[
      'You are looking for a trading strategy or signal service',
      'You want quick fixes without doing the inner work',
      'You are not ready to look honestly at your patterns',
    ]}
    price="$997"
    pricingSummary={[
      'Personalized PersonaForce Trader™ Blueprint Map',
      '4 weekly group sessions with Dr. Travis Fox',
      'Triggered Trader pattern analysis + interruption protocols',
      'Voice & text support across the full 30 days',
    ]}
    paymentLink="https://link.fastpaydirect.com/payment-link/6a4690fba655fa0b802a2642"
  />
);

export default PftThirtyDay;
