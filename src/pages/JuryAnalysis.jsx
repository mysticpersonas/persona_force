...
const VsCard = ({ leftLabel, rightLabel, leftCaption, rightCaption }) => (
  <div className="relative rounded-[18px] overflow-hidden border border-white/[0.07] shadow-[0_0_40px_rgba(59,111,232,0.1)] aspect-[16/10]">
    ...
    {/* VS badge */}
    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-11 h-11 md:w-12 md:h-12 rounded-full bg-[#06081a] border border-[#3b6fe8]/[0.4] flex items-center justify-center text-[12px] md:text-[13px] font-display font-normal text-[#5b8af5] shadow-[0_0_24px_rgba(59,111,232,0.4)]">VS</div>
  </div>
);
    ...
    <div className="min-h-screen bg-[#06081a] text-[#eef0ff] font-sans overflow-x-hidden selection:bg-[#3b6fe8]/30 selection:text-white">
          ...
          <FadeUp delay={100}>
            <div>
              <h2 className="text-[clamp(20px,2.8vw,28px)] font-display font-normal leading-[1.18] tracking-[-0.4px] mb-4">
                The Problem With Traditional <em className="italic bg-[linear-gradient(102deg,#ffffff_0%,#c3d3ff_40%,#5b8af5_100%)] bg-clip-text text-transparent">Jury Simulation.</em>
              </h2>
        ...
        <div className="max-w-[1000px] mx-auto">
          <FadeUp>
            ...
            <h2 className="text-[clamp(22px,3.5vw,34px)] font-display font-normal text-center leading-[1.12] tracking-[-0.015em] mb-3">
              Introducing Juror Identity <em className="italic bg-[linear-gradient(102deg,#ffffff_0%,#c3d3ff_40%,#5b8af5_100%)] bg-clip-text text-transparent">Architecture™</em>
            </h2>
      ...
      <section className="relative overflow-hidden py-16 md:py-24 px-5 md:px-8">
        ...
        <div className="relative z-[1] max-w-[1000px] mx-auto">
          <FadeUp>
            ...
            <h2 className="text-[clamp(22px,3.5vw,34px)] font-display font-normal leading-[1.12] tracking-[-0.015em] mb-2">What Attorneys Actually Get</h2>
      ...
      <section className="py-16 md:py-24 px-5 md:px-8">
        <div className="max-w-[1000px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-14 items-center">
          ...
          <FadeUp delay={100}>
            <div>
              <h2 className="text-[clamp(20px,2.8vw,28px)] font-display font-normal leading-[1.18] tracking-[-0.4px] mb-4">Why This Matters</h2>
      ...
      <section className="relative overflow-hidden py-16 md:py-24 px-5 md:px-8 border-y border-white/[0.06]">
        ...
        <div className="relative z-[1] max-w-[1000px] mx-auto">
          <FadeUp>
            <h2 className="text-[clamp(22px,3.5vw,34px)] font-display font-normal leading-[1.12] tracking-[-0.015em] mb-2">Built for High Stakes Litigation</h2>
      ...
      <section className="py-16 md:py-24 px-5 md:px-8">
        <div className="max-w-[1000px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-14 items-center">
          ...
          <FadeUp delay={100}>
            <div>
              <h2 className="text-[clamp(20px,2.8vw,28px)] font-display font-normal leading-[1.18] tracking-[-0.4px] mb-4">
                This Is Not Jury Research. <em className="italic bg-[linear-gradient(102deg,#ffffff_0%,#c3d3ff_40%,#5b8af5_100%)] bg-clip-text text-transparent">It Is Jury Psychology.</em>
              </h2>
        ...
        <div className="max-w-[1000px] mx-auto">
          <FadeUp>
            <div className="relative overflow-hidden bg-white/[0.04] border border-[#3b6fe8]/[0.28] rounded-[20px] p-9 md:p-[56px_48px] text-center shadow-[0_0_60px_rgba(59,111,232,0.08)]">
              ...
              <h2 className="text-[clamp(24px,4vw,40px)] font-display font-normal tracking-[-0.015em] mb-3.5">Win the room. <em className="italic bg-[linear-gradient(102deg,#ffffff_0%,#c3d3ff_40%,#5b8af5_100%)] bg-clip-text text-transparent">Before you enter it.</em></h2>
