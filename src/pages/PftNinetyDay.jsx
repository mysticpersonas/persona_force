...
const PftNinetyDay = () => (
  <ProductPage
    ...
    forYou={[
      ...
      'You want private 1:1 access with Dr. Travis Fox directly',
      'Your patterns are complex, long-standing, or high-stakes',
      'You are a professional, institutional, or high-volume trader',
      'You are ready to commit fully to 90 days of identity reconstruction',
    ]}
    notForYou={[
      'You are looking for trading signals or strategy',
      'You are not ready for deep, sustained personal work',
      'You want group pricing or a lower commitment level',
    ]}
    price="$2,497"
    pricingSummary={[
      '12 weekly private 1:1 sessions with Dr. Travis Fox',
      'The most detailed Blueprint Map + subconscious mapping',
      'Full Triggered Trader interruption work',
      'Priority voice, text & email support across 90 days',
    ]}
    paymentLink="https://link.fastpaydirect.com/payment-link/6a4691bcd6425bc9468479d5"
  />
);

export default PftNinetyDay;
