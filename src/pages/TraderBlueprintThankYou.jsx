...
/**
 * /trader/blueprintthankyou — shown after the free Blueprint form is submitted.
 * Short confirmation. Private (noindex,nofollow), not linked publicly.
 */
const TraderBlueprintThankYou = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
...
export default TraderBlueprintThankYou;
