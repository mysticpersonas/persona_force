...
const PftSixtyDay = () => (
  <ProductPage
    docTitle="60-Day Mapping · PersonaForce Trader™"
    bookSource="pft-60day"
    ...
    forYou={[
      'Your patterns are deep-rooted and keep returning under pressure',
      'You started identity work and want to go further',
      'You want more time and support than 30 days provides',
      'You are dealing with complex emotional trading patterns',
      'You are ready for sustained, structured identity work',
    ]}
    notForYou={[
      'You want a trading strategy or course',
      'You are not ready to commit to 60 days of focused work',
      'You are looking for overnight results',
    ]}
    price="$1,497"
    pricingSummary={[
      'Full Core / Shadow / Oracle Trader™ Blueprint Map',
      '8 bi-weekly group sessions over 60 days',
      'Shadow Trader interruption protocols',
      'Voice & text support across the full 60 days',
    ]}
    paymentLink="https://link.fastpaydirect.com/payment-link/6a469181d6425bc9468479d4"
  />
);

export default PftSixtyDay;
