...
const CTAButton = ({ onClick, glow = false, className = '' }) => (
  <button
    onClick={onClick}
    className={`inline-flex items-center gap-2 bg-[#00e676] hover:bg-[#3bff9b] text-[#0b0f14] px-5 py-3 text-[14px] sm:px-7 sm:py-4 sm:text-[15px] rounded-xl font-bold tracking-[-0.2px] transition-colors ${
      glow ? 'animate-[pftGlow_3s_ease-in-out_infinite]' : 'shadow-[0_0_24px_rgba(0,230,118,0.25)] hover:shadow-[0_0_34px_rgba(0,230,118,0.4)]'
    } ${className}`}
  >
...
const DAYS = [
  { n: 1, title: 'Who Is The Trader?', focus: 'Identify the version of you making trading decisions.', color: '#00e676' },
  { n: 2, title: 'The Invisible Trade', focus: 'See what happens before you click, enter, exit, hold, or hesitate.', color: '#2ee08a' },
  { n: 3, title: 'The Identity Gap', focus: 'Discover why smart traders break rules they already understand.', color: '#00c2ff' },
  { n: 4, title: 'Pressure Reveals Identity', focus: 'Recognize who takes over when money, fear, and uncertainty collide.', color: '#4f7cff' },
  { n: 5, title: 'Meet Your Future Trader', focus: 'Define the version of you that should lead your next 90 days.', color: '#7b2cff', payoff: true },
];
...
const WALK_AWAY = [
  ...
  'A chance to be considered for a private Trader’s Journey Map.',
];
    ...
    <div className="relative min-h-screen bg-[#0b0f14] text-white font-tj-body overflow-x-hidden selection:bg-[#00e676]/30 selection:text-white antialiased">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-[860px] mx-auto px-5 md:px-8 pt-12 pb-20 md:pt-20 md:pb-32 text-center">
          ...
          <div className="inline-flex items-center gap-2 bg-white/[0.04] border border-[#00e676]/[0.3] text-[#00e676] text-[10px] md:text-[11px] font-bold tracking-[0.16em] uppercase py-1.5 px-4 rounded-full mb-7 opacity-0 animate-[wordUp_0.6s_cubic-bezier(0.16,1,0.3,1)_both]">
          ...
          <h1 className="text-[clamp(27px,7vw,68px)] font-tj-display font-black uppercase leading-[1.08] md:leading-[1.04] tracking-[0.02em] md:tracking-[-1.5px] flex flex-wrap justify-center gap-x-[0.22em] gap-y-0.5 max-w-[760px] mx-auto">
            {HERO_WORDS.map((w, i) =>
              w.t === 'break' ? (
                ...
                <span
                  ...
                  className={`inline-block opacity-0 animate-[wordUp_0.6s_cubic-bezier(0.16,1,0.3,1)_both] ${
                    w.accent ? 'bg-gradient-to-br from-[#00e676] to-[#7b2cff] bg-clip-text text-transparent' : ''
                  }`}
          ...
          <p
            className="text-[15px] md:text-[18px] text-[#8a93a3] max-w-[600px] mx-auto mt-7 leading-[1.7] opacity-0 animate-[wordUp_0.7s_cubic-bezier(0.16,1,0.3,1)_both]"
          ...
          <div className="opacity-0 animate-[wordUp_0.7s_cubic-bezier(0.16,1,0.3,1)_both]" style={{ animationDelay: '700ms' }}>
            ...
            <div className="mt-5 flex flex-wrap items-center justify-center gap-x-4 gap-y-1.5 text-[11.5px] font-semibold text-[#8b93ad]">
              <span className="flex items-center gap-1.5"><span className="w-1 h-1 rounded-full bg-[#00e676]" /> Free</span>
              <span className="flex items-center gap-1.5"><span className="w-1 h-1 rounded-full bg-[#00e676]" /> 5 Days</span>
              <span className="flex items-center gap-1.5"><span className="w-1 h-1 rounded-full bg-[#00e676]" /> Invited traders only</span>
            </div>
      ...
      <section className="px-5 md:px-8 py-20 md:py-28">
        <div className="max-w-[960px] mx-auto">
          <Rise className="text-center mb-12 md:mb-14">
            <div className="text-[11px] font-bold tracking-[0.2em] uppercase text-[#00e676] mb-4">The Blind Spot</div>
            <h2 className="text-[clamp(22px,3.6vw,34px)] font-tj-display font-black uppercase tracking-[0.02em] leading-[1.25] max-w-[700px] mx-auto">
          ...
          <Rise delay={100}>
            <p className="text-center text-[15px] md:text-[16px] text-[#8a93a3] max-w-[640px] mx-auto leading-[1.75]">
          ...
          <Rise delay={140} className="flex justify-center my-8">
            <div className="flex flex-col items-center">
              <div className="w-px h-8 bg-gradient-to-b from-white/10 to-[#00e676]/50" />
              <ChevronDown className="w-4 h-4 text-[#00e676] -mt-1" />
            </div>
          </Rise>

          {/* the person placing the trade */}
          <Rise delay={180}>
            <div className="relative max-w-[540px] mx-auto rounded-2xl p-7 md:p-9 text-center bg-gradient-to-b from-[#11151d] to-[#0b0f14] border border-[#00e676]/25 shadow-[0_0_50px_rgba(0,230,118,0.12)]">
              <div className="w-12 h-12 mx-auto rounded-xl bg-gradient-to-br from-[#00e676] to-[#7b2cff] flex items-center justify-center mb-5 shadow-[0_0_24px_rgba(0,230,118,0.45)]">
                <Eye className="w-6 h-6 text-white" />
              </div>
              <p className="text-[17px] md:text-[20px] font-bold text-white leading-snug">The person placing the trade.</p>
              <p className="text-[13.5px] md:text-[14px] text-[#8a93a3] mt-3 leading-[1.65]">
              ...
              <div className="mt-6 pt-5 border-t border-white/[0.07] text-[10.5px] font-bold tracking-[0.16em] uppercase text-[#00e676]">
                The Trader’s Journey Identity Check
              </div>
            </div>
          </Rise>

          <Rise delay={220}>
            <p className="text-center mt-9 text-[13px] tracking-[0.14em] uppercase font-bold bg-gradient-to-r from-[#00e676] to-[#7b2cff] bg-clip-text text-transparent">
      ...
      <section className="relative overflow-hidden px-5 md:px-8 py-24 md:py-36 border-y border-white/[0.05] bg-[radial-gradient(ellipse_at_center,rgba(123,44,255,0.08)_0%,transparent_70%)]">
        <div className="pointer-events-none absolute top-6 left-1/2 -translate-x-1/2 text-[180px] md:text-[260px] leading-none font-tj-display font-black uppercase text-white/[0.025] select-none">&ldquo;</div>

        <div className="relative max-w-[900px] mx-auto text-center">
          <BlurReveal>
            <div className="flex items-center justify-center gap-3 mb-8">
              <span className="w-8 md:w-12 h-px bg-gradient-to-r from-transparent to-[#00e676]/60" />
              <span className="text-[11px] font-bold tracking-[0.22em] uppercase text-[#00e676]">The Trader’s Journey Principle</span>
              <span className="w-8 md:w-12 h-px bg-gradient-to-l from-transparent to-[#7b2cff]/60" />
            </div>
          </BlurReveal>

          <BlurReveal>
            <h2 className="text-[clamp(26px,5vw,52px)] font-tj-display font-black uppercase leading-[1.18] tracking-[0.02em]">
              The market does not create your identity.
              <br className="hidden md:block" />{' '}
              <span className="bg-gradient-to-r from-[#00e676] to-[#7b2cff] bg-clip-text text-transparent">
                It reveals it.
              </span>
            </h2>
          </BlurReveal>
          ...
          <BlurReveal className="flex justify-center mt-8">
            <span className="block h-[3px] w-24 rounded-full bg-gradient-to-r from-[#00e676] to-[#7b2cff]" />
          </BlurReveal>

          <BlurReveal className="mt-8">
            <p className="text-[15px] md:text-[17px] text-[#8a93a3] max-w-[600px] mx-auto leading-[1.7]">
      ...
      <section className="px-5 md:px-8 py-20 md:py-28">
        <div className="max-w-[820px] mx-auto text-center">
          <Rise>
            <div className="text-[11px] font-bold tracking-[0.2em] uppercase text-[#00e676] mb-4">Why This Is Different</div>
            <h2 className="text-[clamp(22px,3.6vw,36px)] font-tj-display font-black uppercase tracking-[0.02em] leading-[1.22]">
          ...
          <div className="mt-10 grid sm:grid-cols-2 gap-4 text-left">
            <Rise delay={100}>
              <div className="h-full rounded-2xl bg-white/[0.02] border border-white/[0.07] p-6">
                ...
                <p className="text-[15px] text-[#8a93a3] leading-[1.6]">Begin with strategy, what to trade, which system to use, how the setup works.</p>
              </div>
            </Rise>
            <Rise delay={180}>
              <div className="h-full rounded-2xl bg-gradient-to-b from-[#11151d] to-[#0b0f14] border border-[#7b2cff]/30 p-6 shadow-[0_0_40px_rgba(123,44,255,0.12)]">
                <div className="text-[11px] font-bold tracking-[0.14em] uppercase text-[#a98bff] mb-3">The Trader’s Journey</div>
                <p className="text-[15px] text-[#c3cad6] leading-[1.6]">Begins with the trader, what happens inside you when the trade becomes emotional, uncertain, pressured, or personal.</p>
              </div>
            </Rise>
          </div>
          ...
          <Rise delay={240}>
            <p className="mt-9 text-[16px] md:text-[18px] font-bold text-white">
              The goal is simple: <span className="bg-gradient-to-r from-[#00e676] to-[#7b2cff] bg-clip-text text-transparent">reveal the trader behind the trade.</span>
            </p>
          </Rise>
        </div>
      </section>
      ...
      <section className="px-5 md:px-8 py-20 md:py-28 border-t border-white/[0.05]">
        <div className="max-w-[1100px] mx-auto">
          <Rise className="text-center mb-14 md:mb-16">
            <div className="text-[11px] font-bold tracking-[0.2em] uppercase text-[#00e676] mb-3">The Identity States</div>
            <h2 className="text-[clamp(24px,4vw,40px)] font-tj-display font-black uppercase tracking-[0.02em] leading-[1.2]">
              Three versions of you can show up<br className="hidden sm:block" /> in every trade.
            </h2>
            <p className="text-[14px] md:text-[15px] text-[#8a93a3] mt-5 max-w-[560px] mx-auto leading-[1.65]">
            ...
            {TRADERS.map((t, i) => (
              <Rise key={t.name} delay={i * 120}>
                <div className="group h-full rounded-2xl bg-white/[0.025] border border-white/[0.07] p-7 transition-all duration-300 hover:-translate-y-1 hover:bg-white/[0.04]">
                  ...
                  <p className="text-[13.5px] text-[#8a93a3] leading-[1.65]">{t.desc}</p>
      ...
      <section className="px-5 md:px-8 py-20 md:py-28">
        <div className="max-w-[760px] mx-auto text-center">
          <Rise>
            <h2 className="text-[clamp(22px,3.6vw,34px)] font-tj-display font-black uppercase tracking-[0.02em]">What changes when pressure hits?</h2>
            <p className="text-[15px] md:text-[16px] leading-[1.7] text-[#8a93a3] mt-5 max-w-[600px] mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-2.5 mt-8">
            {COLLIDE.map((word, i) => (
              <Rise key={word} delay={i * 55}>
                <span className="inline-block bg-white/[0.04] border border-white/[0.08] text-[#c3cad6] text-[12px] md:text-[13px] font-semibold tracking-[0.02em] px-4 py-2 rounded-full hover:border-[#00e676]/40 hover:text-white transition-colors">
                  {word}
                </span>
              </Rise>
            ))}
      ...
      <section className="px-5 md:px-8 py-16 md:py-24">
        <div className="max-w-[1100px] mx-auto">
          <Rise className="text-center mb-16 md:mb-20">
            <div className="text-[11px] font-bold tracking-[0.2em] uppercase text-[#00e676] mb-3">The Challenge</div>
            <h2 className="text-[clamp(24px,4vw,40px)] font-tj-display font-black uppercase tracking-[0.02em]">Five Days. One Question.</h2>
            <p className="text-[15px] md:text-[17px] text-[#8a93a3] mt-4 font-medium">Who is placing the trade?</p>
          </Rise>
          ...
          <div ref={lineRef} className="relative">
            ...
            <div className="hidden md:block absolute top-7 left-[10%] w-[80%] h-px origin-left transition-transform duration-[1400ms] ease-[cubic-bezier(0.16,1,0.3,1)]"
              style={{ background: 'linear-gradient(90deg,#00e676,#7b2cff)', transform: lineIn ? 'scaleX(1)' : 'scaleX(0)' }}
            />
            ...
            <div className="md:hidden absolute left-6 top-6 bottom-6 w-px origin-top transition-transform duration-[1400ms] ease-[cubic-bezier(0.16,1,0.3,1)]"
              style={{ background: 'linear-gradient(180deg,#00e676,#7b2cff)', transform: lineIn ? 'scaleY(1)' : 'scaleY(0)' }}
            />
              ...
              {DAYS.map((d, i) => (
                <Rise key={d.n} delay={i * 110}>
                  <div className="group flex md:flex-col items-start md:items-center gap-4 text-left md:text-center">
                    <div
                      className={`relative z-10 shrink-0 rounded-full flex items-center justify-center font-black bg-[#0b0f14] border-2 transition-transform duration-300 group-hover:scale-110 ${
      ...
      <section className="px-5 md:px-8 py-20 md:py-28 border-t border-white/[0.05]">
        <div className="max-w-[860px] mx-auto">
          <SlideIn from="left" className="mb-10 text-center md:text-left">
            <h2 className="text-[clamp(22px,3.6vw,34px)] font-tj-display font-black uppercase tracking-[0.02em]">This is for you if…</h2>
          </SlideIn>
            ...
            {FOR_YOU.map((line, i) => (
              <SlideIn key={i} from="left" delay={80 + i * 70}>
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-[14px] md:text-[15px] text-[#c3cad6] leading-[1.55]">{line}</p>
                </div>
              </SlideIn>
            ))}
          </div>

          {/* Centred at every width. The checklist above is left-aligned, but every
              other CTA on the page sits centred, and a button is a page-level
              action rather than part of the list it follows. */}
          <SlideIn from="left" delay={80 + FOR_YOU.length * 70} className="flex justify-center mt-12">
            <CTAButton onClick={scrollToForm} />
          </SlideIn>
        </div>
      </section>
      ...
      <section className="px-5 md:px-8 py-20 md:py-28">
        <div className="max-w-[900px] mx-auto">
          <Rise className="text-center mb-12">
            <div className="text-[11px] font-bold tracking-[0.2em] uppercase text-[#a98bff] mb-3">The Takeaway</div>
            <h2 className="text-[clamp(22px,3.6vw,34px)] font-tj-display font-black uppercase tracking-[0.02em]">What you&rsquo;ll walk away with</h2>
          </Rise>
          <div className="grid sm:grid-cols-2 gap-4">
            {WALK_AWAY.map((line, i) => (
              <Rise key={i} delay={i * 90}>
                <div className="flex items-start gap-3.5 h-full rounded-xl bg-white/[0.025] border border-white/[0.07] p-5 hover:border-[#7b2cff]/35 transition-colors">
                  <span className="mt-0.5 shrink-0 w-6 h-6 rounded-lg bg-[#7b2cff]/15 border border-[#7b2cff]/40 flex items-center justify-center">
                    <Check className="w-3.5 h-3.5 text-[#a98bff]" strokeWidth={3} />
                  </span>
                  <p className="text-[14px] md:text-[15px] text-[#c3cad6] leading-[1.55]">{line}</p>
                </div>
              </Rise>
            ...
            {NOT_THIS.map((line, i) => (
              <Rise key={i} delay={i * 60}>
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-[14px] text-[#8a93a3] leading-[1.55]">{line}</p>
                </div>
              </Rise>
            ))}
          </div>
          <Rise delay={80}>
            <p className="mt-6 pt-5 border-t border-white/[0.06] text-[13.5px] text-[#c3cad6] leading-[1.6]">
      ...
      {/* ======================= 11 · THE FORM ======================== */}
      <section id="register" className="px-4 sm:px-6 md:px-8 py-16 md:py-24 scroll-mt-[70px] bg-[radial-gradient(ellipse_at_center,rgba(0,230,118,0.06)_0%,transparent_70%)]">
        <div className="max-w-[640px] mx-auto text-center">
          ...
          <Rise>
            <div className="flex items-start gap-3 text-left max-w-[540px] mx-auto mb-10 rounded-xl bg-white/[0.03] border border-white/[0.07] px-5 py-4">
              <Lock className="w-4 h-4 text-[#00e676] mt-0.5 shrink-0" />
              <p className="text-[13px] text-[#8a93a3] leading-[1.6]">
          ...
          <Rise>
            <div className="inline-flex items-center gap-2 text-[11px] font-bold tracking-[0.16em] uppercase text-[#00e676] mb-5">
            ...
            <h2 className="text-[clamp(26px,4.5vw,42px)] font-tj-display font-black uppercase tracking-[0.02em]">Join the Private PFT Pilot</h2>
            <p className="text-[14px] md:text-[15px] text-[#8a93a3] mt-4 max-w-[480px] mx-auto leading-[1.65]">
          ...
          <Rise delay={80}>
            <div className="flex flex-col sm:flex-row items-stretch justify-center gap-2.5 mt-8 max-w-[560px] mx-auto">
              {[
                ...
                <div key={i} className="flex items-center gap-2 flex-1 justify-center rounded-lg bg-white/[0.03] border border-white/[0.07] px-3 py-2.5 text-[12px] font-semibold text-[#c3cad6]">
                  <it.icon className="w-3.5 h-3.5 text-[#00e676] shrink-0" />
                  {it.text}
                </div>
              ))}
            </div>
          ...
          <div
            ref={formRef}
            className={`mt-8 md:mt-10 rounded-xl md:rounded-2xl bg-white/[0.03] border border-white/[0.09] p-1.5 sm:p-3 md:p-4 shadow-[0_0_60px_rgba(0,230,118,0.1)] transition-all duration-[800ms] ease-[cubic-bezier(0.16,1,0.3,1)] ${
      ...
      <div className={`lg:hidden fixed bottom-0 left-0 right-0 z-40 px-4 pt-3 pb-[max(12px,env(safe-area-inset-bottom))] bg-[#0b0f14]/95 backdrop-blur-md border-t border-white/[0.08] transition-all duration-300 ${isScrolled && !formIn ? 'translate-y-0 opacity-100' : 'translate-y-full opacity-0 pointer-events-none'}`}>
        <button onClick={scrollToForm} className="w-full inline-flex items-center justify-center gap-2 bg-[#00e676] hover:bg-[#3bff9b] text-[#0b0f14] py-3.5 rounded-xl text-[15px] font-bold shadow-[0_0_24px_rgba(0,230,118,0.35)]">
          Join the Private Pilot <ArrowRight className="w-4 h-4" />
        </button>
      </div>
      </div>
