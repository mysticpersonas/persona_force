...
const OrientationReplay = () => {
  useEffect(() => {
    ...
    document.title = 'Orientation Replay · The Trader’s Journey';
        ...
        <div className="max-w-[760px] mx-auto">
          ...
          <FadeUp>
            <div className="text-center">
              ...
              <h1 className="text-[clamp(28px,5vw,46px)] font-tj-display font-black uppercase tracking-[0.02em] leading-[1.12] mt-6 max-w-[640px] mx-auto">
                You Missed Live. Here&rsquo;s the Full Orientation.
              </h1>
              <p className="text-[15px] md:text-[18px] text-[#ffffff]/[0.58] mt-5">
          ...
          {/* 3 — INTRO PARAGRAPH */}
          <FadeUp delay={120}>
            <p className="text-[14px] md:text-[15px] text-[#ffffff]/[0.58] leading-[1.85] mt-10 max-w-[620px] mx-auto text-center">
              This is the exact orientation we ran live, covering what The Trader’s Journey is, what
          ...
          <FadeUp delay={160}>
            <div className="mt-10 md:mt-12 rounded-[14px] md:rounded-[24px] overflow-hidden bg-black border border-[#00e676]/[0.32] shadow-[0_0_40px_rgba(0,230,118,0.12),0_15px_30px_rgba(0,0,0,0.4)] md:shadow-[0_0_80px_rgba(0,230,118,0.22),0_32px_80px_rgba(0,0,0,0.7)]">
              <div style={{ position: 'relative', paddingBottom: '56.25920471281296%', height: 0 }}>
                <iframe
                  ...
                  allowFullScreen
                  title="The Trader's Journey Orientation"
          ...
          <FadeUp delay={200}>
            <div className="flex flex-col items-center gap-2.5 mt-5">
              <p className="text-[12.5px] text-[#ffffff]/[0.4]">Video not loading? Watch it directly here:</p>
              <a
                href={`https://www.loom.com/share/${LOOM_ID}`}
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-1.5 bg-white/[0.04] hover:bg-white/[0.08] border border-white/[0.12] text-[#ffffff]/[0.85] hover:text-white px-4 py-2 rounded-lg text-[12.5px] font-semibold transition-colors"
              >
          ...
          <div className="my-14 md:my-20 flex items-center gap-4">
            ...
            <span className="w-1.5 h-1.5 rounded-full bg-[#00e676]/50 shrink-0" />
            <div className="h-px flex-1 bg-gradient-to-l from-transparent to-white/[0.1]" />
          </div>

          <FadeUp>
            <div className="text-center max-w-[560px] mx-auto">
              <h2 className="text-[clamp(24px,4vw,36px)] font-tj-display font-black uppercase tracking-[0.02em]">Ready to Begin?</h2>
              <p className="text-[15px] md:text-[16px] text-[#ffffff]/[0.58] mt-4 leading-[1.7]">
              ...
              <div className="mt-8 flex flex-col items-center">
                <Link
                  to="/opt-in"
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-[#00e676] hover:bg-[#00e676]/90 text-white px-8 py-4 rounded-[10px] text-[15px] font-bold shadow-[0_0_28px_rgba(0,230,118,0.28)] transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[0_0_44px_rgba(0,230,118,0.45)]"
                >
                  Join the 5-Day Challenge <ArrowRight className="w-4 h-4" />
                </Link>
                {/* 8 — CTA MICROCOPY */}
                <p className="text-[12px] text-[#ffffff]/[0.38] mt-4">Takes less than a minute.</p>
              </div>
            </div>
          </FadeUp>
        </div>
